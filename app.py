...
def render():
    # Atualiza automaticamente a página a cada 10 segundos (10000 ms) para detetar novos pedidos instantaneamente
    st_autorefresh(interval=10000, key="datarefresh_admin")
