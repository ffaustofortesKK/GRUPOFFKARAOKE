...
def _inicializar_firebase():
    if not firebase_admin._apps:
        try:
            ...
            # Usa o Google Auth nativo para gerar as credenciais a partir do dicionário tratado
            google_cred = service_account.Credentials.from_service_account_info(cred_dict)
